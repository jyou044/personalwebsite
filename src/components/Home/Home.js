        ...
        <div>
            ...
            <Grid container className={classes.flexVal}>
                <Grid item xs={12} md={4} className={classes.paraFormat} style={{ padding: 20 }}>
                    <p> <b>Hi there! Welcome to my portfolio website. I'm an aspiring software engineer with a variety of interests ranging from web development to project management.
