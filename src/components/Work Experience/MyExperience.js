    ...
    return (
        <div >
            ...
            <Grid item container className={classes.flexVal}>
                ...
                <Grid item xs={12} lg={3} className={classes.paraFormat} style={{ padding: 20 }}>
                    <p><b>I worked with the Central Help Desk team at the Government of Canada (GOC) as a Level 1 Technical Analyst. I provided client support by phone and email in addition to advising GOC
